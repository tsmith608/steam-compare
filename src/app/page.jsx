...
import "./components/compareButton.scss";
...
function HomeContent() {
  ...
  return (
    <main className="min-h-screen w-full flex flex-col bg-black relative selection:bg-blue-500/30 selection:text-blue-200 overflow-x-hidden">
      ...
      {/* Animated background only on landing (above feature demo) */}
      {!data && (
        <AnimatedBackground>
          <div className="w-full max-w-6xl mx-auto px-6 pt-20 pb-12 flex flex-col items-center text-center relative z-10">
            <header className="w-full text-center pt-16 sm:pt-24">
              ...
              <div className="mt-8 flex justify-center">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold transition-all hover:scale-105 shadow-lg shadow-[#5865F2]/25 group animate-breathing"
                >
            ...
            <div
              ...
              scroll-mt-24 sm:scroll-mt-36 sticky z-20`}
            >
              <CleanDataEntryForm
                users={users}
                setUsers={setUsers}
      ...
      {/* Section 2: Promotional Sections - Independent Widths */}
      {!data && (
        <>
          <FeatureDemoSection />
          ...
          <div className="w-full max-w-6xl mx-auto px-6 pt-2 pb-10 text-center relative z-10 flex flex-col items-center">
            <ModernFAQSection />
      ...
      {/* Section 3: Results Section (Contained) */}
      {data && (
            ...
            <div className="mx-auto max-w-6xl px-3 sm:px-6">
              <div className="mt-3 flex items-center justify-between gap-3
                ...
                <button
                  ...
                  style={{ '--btn-scale': '0.6' }}
                  className="compare_btn_wrapper px-5 py-2 rounded-xl font-medium
