                        ...
                        <div className="bg-white/5 backdrop-blur rounded-3xl border border-white/10 shadow-xl shadow-black/20 p-8 flex flex-col h-full hover:bg-white/[0.07] transition-all">
                            ...
                            {userTier === 'Noob' ? (
                                <div className="space-y-3 mt-8">
                                    <button className="w-full block text-center bg-white/10 text-gray-400 font-semibold py-3 rounded-xl cursor-default text-sm border border-white/5">
                                        Current Plan
                                    </button>
                                    <Link
                                        ...
                                        target="_blank"
                                        className="w-full flex items-center justify-center gap-2 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold py-3 rounded-xl transition-all text-sm group"
                                    >
                                    ...
                                    <p className="text-[10px] text-gray-500 text-center">Download the basic version of our Discord Bot.</p>
                                </div>
                            ) : (
                                <div className="space-y-3 mt-8">
                                    <Link
                                        href="/"
                                        className="w-full block text-center bg-white/10 hover:bg-white/20 text-white font-semibold py-3 rounded-xl transition-colors text-sm hover:scale-[1.02] transform"
                                    >
                                        Downgrade Info
                                    </Link>
                                    <Link
