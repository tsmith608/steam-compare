...
export default function SiteFooter() {
    return (
        <footer className="w-full py-6 mt-10 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                {/* Links */}
                <nav className="flex flex-wrap justify-center md:justify-end gap-x-8 gap-y-4 text-sm text-gray-400 font-medium">
                    <Link href="/#faq" className="hover:text-white transition-colors">FAQ</Link>
                    <Link href="/upgrade" className="hover:text-amber-400 transition-colors flex items-center gap-1.5">
